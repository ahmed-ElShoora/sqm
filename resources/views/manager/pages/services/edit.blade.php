            ...
            <div class="col-12">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{Route('ServiceController.update',$service->id)}}">
                        @csrf
                        ...
                        <div class="tooltip-center-bottom position-relative form-group">
                            <label>النقاط باللغة الانجليزية</label><br>
                            ...
                            <div class="invalid-tooltip">النقاط باللغة الانجليزية</div>
                        </div>
                         <div class="tooltip-center-bottom position-relative form-group">
                            <label>النقاط باللغة العربية</label><br>
                            <h6>يرجي مراعاه ادخال النقاط مع فصلهم باستحدام [,] لفصلهم</h6>
                            <textarea name="notes_ar" required="" id="notes_ar" class="form-control" value="{{ $service->notes_ar }}">{{ $service->notes_ar }}</textarea>
                            <div class="invalid-tooltip">النقاط باللغة العربية</div>
                        </div>
                        @endif
