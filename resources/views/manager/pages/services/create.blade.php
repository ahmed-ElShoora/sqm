            ...
            <div class="col-12">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <form method="post" enctype="multipart/form-data" action="{{Route('ServiceController.store',$id)}}">
                        ...
                        <div class="tooltip-center-bottom position-relative form-group col-4">
                            <h5 class="">الصورة</h5>
                                <input type="file" required id="inputImage" name="image" accept=".jpg,.jpeg,.png,.gif,.bmp,.tiff">
                        </div>
                        @endif
