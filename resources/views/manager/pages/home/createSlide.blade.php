            ...
            <div class="col-12">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <form method="post" action="{{Route('HomePageController.storeSlide')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="tooltip-label-right">
                            <div class="error-l-100 position-relative form-group">
                                ...
                                <input type="file" required id="photo" name="photo" accept=".jpg,.jpeg,.png,.gif,.bmp,.tiff">
                            </div>
                        </div>
